...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
	...
	<head>
	<title>SQLBoon | <?php echo $settings['sitename']; ?></title>
...
function topmenu()
{
	...
	$content .= '<li><a href="backup.php">Quick Backup</a></li>';
	$content .= '<li><a href="backup.php?fct=manualbackup">Manual Backup</a></li>';
	$content .= '<li><a href="backup.php?fct=listbackups">List Backups</a></li>';
...
$content .= '<input type="text" name="hostname" class="input" value="'.$_POST['hostname'].'"/>';
...
$content .= '<input type="text" name="database" class="input" value="'.$_POST['database'].'"/>';
...
$content .= '<input type="text" name="username" class="input" value="'.$_POST['username'].'"/>';
...
$content .= '<input type="password" name="password" class="input" value="'.$_POST['password'].'"/>';
...
function backup($hostname, $database, $username, $password, $tables, $email, $suppress, $id)
{
	...
	$handle = fopen($settings['backupfolder'].'/'.$subfolder.'/'.mktime().'-'.$database.'-backup.sql','w+');
	$filename = $settings['backupfolder'].'/'.$subfolder.'/'.mktime().'-'.$database.'-backup.sql';
	fwrite($handle,$return);
	fclose($handle);
	
	if($settings['compression']=='on')
	{
	$destination = $settings['backupfolder'].'/'.$subfolder.'/'.mktime().'-'.$database.'-backup.zip';
...
function restore()
{
	...
	if(!$errors)
	{
		...
		$getdatabase = addslashes($_GET['database']);
		$hostname = $settings['hostname'][$getdatabase];
		$database = $settings['database'][$getdatabase];
		$username = $settings['username'][$getdatabase];
		$password = $settings['password'][$getdatabase];
	}
...
$content .= '</p>';
$content .= '<p><span class="inputlabel">Hostname:</span>';	
$content .= '<input type="text" name="hostname" class="input" value="'.$hostname.'"/>';
$content .= '<img src="images/information.png" class="adminicon" alt="" onmouseover="return overlib(\'Enter the address to your MySQL server\');" onmouseout="return nd();"/>';
$content .= '</p>';
$content .= '<p><span class="inputlabel">Database Name:</span>';	
...
$content .= '</p>';
$content .= '<p><span class="inputlabel">Username:</span>';	
$content .= '<input type="text" name="username" class="input" value="'.$username.'"/>';
$content .= '<img src="images/information.png" class="adminicon" alt=""/ onmouseover="return overlib(\'Enter the username for this database\');" onmouseout="return nd();">';
$content .= '</p>';
$content .= '<p><span class="inputlabel">Password:</span>';	
...
$content .= '<input type="hidden" name="filename" class="input" value="'.$filename.'"/>';
$content .= '<p><input type="submit" name="submit" value="Restore SQL Backup" class="inputbutton" /></p>';
$content .= '</fieldset>';
$content .= '</form>';	
